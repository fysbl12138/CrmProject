...
<%@ page import="com.bjpowernode.crm.workbench.entity.Tran" %>
<%
    ...
    for (int i = 0; i < dvList.size(); i++) {
        ...
        String possibility = kmap.get(stage);
...
<head>
    ...
    <script type="text/javascript">
        ...
        function changeIcon(stage,index1) {
            ...
            //当前阶段的可能性不为0，前七个可能为绿色标记，绿圈，黑圈，黑两个已定位黑叉
            else{
                for (var i = 0;i<point; i++){
...
<div style="position: relative; left: 40px; top: -50px;">
    ...
    <%
            ...
            //准备当前阶段的可能性
            String possibility = kmap.get(currentStage);
            ...
            if("0".equals(currentStage)){
                ...
                for (int i = 0; i < dvList.size(); i++) {
                    ...
                    String listStagepossibility = kmap.get(listStage);

                    if("0".equals(listStagepossibility)){
