...
<%
    ...
    Map<String, String> kmap = (Map<String, String>) application.getAttribute("kmap");
    Set<String> set = kmap.keySet();
...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            // $("#create-transactionOwner").change(function () {
            //
            //     var t = $("#create-transactionOwner").val();
            //
            //     alert(t)
            //
            // })
...
<form id="tranfrom"  action="workbench/transaction/addtran.do" method="post" class="form-horizontal" role="form" style="position: relative; top: -30px;">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <select class="form-control" id="create-transactionOwner" name="owner">
                <c:forEach items="${uList}" var="o">
                    <option value="${o.id}" ${user.id eq o.id ? "selected" : ""}>${o.name}</option>
                </c:forEach>
            </select>
        </div>
    ...
    <div class="form-group">
        <label for="create-accountName" class="col-sm-2 control-label">客户名称<span
                style="font-size: 15px; color: red;">*</span></label>
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" name="accountName" id="create-accountName"
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            <input type="text" class="form-control" id="create-possibility" name="">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" value="1324b022eadc4c519e58ecf42e3493d3" name="activityId">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10" style="width: 300px;">
            ...
            <input type="hidden" value="0e83e78e4e7444ab8dd0609c8b5220e4" name="contactsId">
        </div>
    </div>
