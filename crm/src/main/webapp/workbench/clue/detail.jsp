...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#tbodyListSearch").on("click",$("input[name=xz]"),function () {
        ...
        function unbund(id) {
            ...
            $.ajax({
                ...
                url : "workbench/clue/deleteActivityAndClueById.do",
...
<div style="position: relative; left: 40px; top: -30px;">
    <div class="page-header">
        <h3>${clueDetail.fullname} <small>${clueDetail.company}</small></h3>
    </div>
    <div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
        <button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.jsp?id=${clueDetail.id}&fullname=${clueDetail.fullname}&appellation=${clueDetail.appellation}&company=${clueDetail.company}&owner=${clueDetail.owner}';"><span
...
<div style="position: relative; top: -70px;">
    <div style="position: relative; left: 40px; height: 30px;">
        ...
        <div style="width: 300px;position: relative; left: 200px; top: -20px;">
            <b>${clueDetail.fullname}${clueDetail.appellation}</b></div>
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 50px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;"><b>${clueDetail.createBy}&nbsp;&nbsp;</b><small
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 60px;">
        ...
        <div style="width: 500px;position: relative; left: 200px; top: -20px;">
            <b>${clueDetail.editBy}&nbsp;&nbsp;</b><small
                style="font-size: 10px; color: gray;">${clueDetail.editTime}</small></div>
        <div style="height: 1px; width: 550px; background: #D5D5D5; position: relative; top: -20px;"></div>
    </div>
    ...
    <div style="position: relative; left: 40px; height: 30px; top: 90px;">
        ...
        <div style="width: 300px;position: relative; left: 200px; top: -20px;"><b>${clueDetail.nextContactTime}</b>
        </div>
